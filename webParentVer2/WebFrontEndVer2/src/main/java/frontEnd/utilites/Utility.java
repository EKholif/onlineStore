...
import frontEnd.security.oauth.CustomerOAuth2User;
...
public class Utility {
    ...
    public static String formatCurrency(float amount, CurrencySettingBag settings) {
        ...
        // [AG-UTIL-001] Defensive Coding: Handle potential null values in settings to
        // prevent NPE.
        if (symbol == null)
            symbol = "$";
        if (symbolPosition == null)
            symbolPosition = "Before price";
        if (decimalPointType == null)
            decimalPointType = "POINT";
        if (thousandPointType == null)
            thousandPointType = "COMMA";
