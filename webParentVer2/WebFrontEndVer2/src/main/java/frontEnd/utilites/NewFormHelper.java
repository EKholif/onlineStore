...
public class NewFormHelper {
    ...
    public ModelAndView newForm(ModelAndView model, String objectName, Object object) {
        ...
        model.addObject("countriesList", listItems );

        model.addObject("pageTitle", pageTitle );
        model.addObject("saveChanges",  "/save-" + objectName);
        return model;
    }
    ...
    public ModelAndView editForm(ModelAndView model, String objectName, Object object, int id ) {
        ...
        model.addObject("countriesList", listItems); // Assuming listItems is a class variable
        model.addObject("pageTitle", pageTitle);
        model.addObject("saveChanges",  "/save-" + objectName);
        return model;
    }
