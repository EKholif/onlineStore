...
/**
 * AG-DATA-INTEGRITY-002: Audit Log Cleanup Runner (Frontend)
 * <p>
 ...
 * <p>
 * EXECUTION ORDER: Runs before JPA initialization to ensure clean schema state.
 */
@Component
...
public class AuditLogCleanupRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("🧹 [Frontend-AuditLogCleanupRunner] Cleaning orphan audit log entries...");
        ...
        System.out.println("🧹 [Frontend-AuditLogCleanupRunner] Complete.");
    }
}
