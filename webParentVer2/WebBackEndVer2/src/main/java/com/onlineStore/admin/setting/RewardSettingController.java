...
public class RewardSettingController {
    ...
    public String viewRewardSettings(Model model) {
        ...
        model.addAttribute("pageTitle", "Reward System Settings");
        return "settings/reward_settings";
    }

    @PostMapping("/save")
    public String saveRewardSettings(RewardSetting setting, RedirectAttributes ra) {
        rewardService.saveSettings(setting);
        ra.addFlashAttribute("message", "Reward settings have been saved successfully.");
