package frontEnd.categoryRepositoryTest;

import com.onlineStoreCom.entity.category.Category;
import com.onlineStoreCom.entity.customer.Customer;
import com.onlineStoreCom.entity.product.Product;
import com.onlineStoreCom.entity.setting.state.Country.Country;
import frontEnd.category.CategoryRepository;
...
public class ProductRepositoryTest {
    ...
    public void  listAllProduct(){
        ...
        Page<Product> productList = productRepository.pageProductOnSale( pageable );
        System.out.println("🔥 test started 🔥"  +  productList.getTotalElements() );  ;
    ...
    void testFindAllByCategoryAlias() {
        ...
        page.getContent().forEach(p ->
                System.out.println(p.getName() + " | Cat: " + p.getCategory().getAlias())
        );
