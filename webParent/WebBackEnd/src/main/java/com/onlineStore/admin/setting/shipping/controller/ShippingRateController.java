...
import com.onlineStore.admin.setting.shipping.service.ShippingRateService;
...
public class ShippingRateController {
    ...
    public ModelAndView listByPage(@PathVariable("pageNum") int pageNum, @RequestParam(name = "sortField", defaultValue = "country") String sortField, @RequestParam(name = "sortDir", defaultValue = "desc") String sortDir, @RequestParam(name = "keyWord", required = false) String keyWord) {
