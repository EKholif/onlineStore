...
public class PdfConvertController {
    ...
    public ModelAndView listAllCategories() {
        ...
        PagingAndSortingHelper pagingAndSortingHelper = new PagingAndSortingHelper("convert", fileExtensions); // Corrected listName
        return pagingAndSortingHelper.newForm(model, "fileConvert", fileConvert);

    }


    @PostMapping("/convert/save-fileConvert")
    public ModelAndView newConvertForm(@ModelAttribute FileConvert fileConvert
